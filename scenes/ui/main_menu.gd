...
func _ready() -> void:
	if Input.is_action_pressed("move_right"):
		...
		Global.debug = true
		#$Settings/Label.text = ProjectSettings.get_setting("application/config/version") + " [DEBUG]"

	$Settings/BG/Label3.text = "Version " + str(ProjectSettings.get_setting("application/config/version"))
...
func _on_level1_button_pressed() -> void:
	Global.level_to_begin = 1
	_on_play_button_pressed()
	
func _on_level1_button_focus_entered() -> void:
	$"Level Select/BG/TextureButton".position.y += 10

func _on_level1_button_focus_exited() -> void:
	$"Level Select/BG/TextureButton".position.y -= 10
	


func _on_level2_button_2_pressed() -> void:
	Global.level_to_begin = 2
	_on_play_button_pressed()

func _on_level2_button_2_focus_entered() -> void:
	$"Level Select/BG/TextureButton2".position.y += 10

func _on_level2_button_2_focus_exited() -> void:
	$"Level Select/BG/TextureButton2".position.y -= 10



func _on_texture_button_3_pressed() -> void:
	Global.level_to_begin = 3
	_on_play_button_pressed()

func _on_level3_button_3_focus_entered() -> void:
	$"Level Select/BG/TextureButton3".position.y += 10

func _on_level3_button_3_focus_exited() -> void:
	$"Level Select/BG/TextureButton3".position.y -= 10
	
	

func _on_level4_button_4_pressed() -> void:
	Global.level_to_begin = 4
	_on_play_button_pressed()

func _on_level4_button_4_focus_entered() -> void:
	$"Level Select/BG/TextureButton4".position.y += 10

func _on_level4_button_4_focus_exited() -> void:
	$"Level Select/BG/TextureButton4".position.y -= 10



func _on_level5_button_5_pressed() -> void:
	Global.level_to_begin = 5
	_on_play_button_pressed()

func _on_level5_button_5_focus_entered() -> void:
	$"Level Select/BG/TextureButton5".position.y += 10

func _on_level5_button_5_focus_exited() -> void:
	$"Level Select/BG/TextureButton5".position.y -= 10
...
func _on_level2_button_focus_exited() -> void:
